...
describe('Function "moviesAverageByCategory"', () => {
  it('should return the average score of movies for a given genre', () => {
    ...
    const averageScore = moviesAverageByCategory(movies, genre);
    expect(averageScore).toBeCloseTo(8.28, 2);
  });

  it('should return 0 if no movies of the given genre are found', () => {
